...
@EnableKafka
@Configuration
public class FormConsumerListeners2<V, T extends Fact<V>> extends EventListener<T> {
    ...
    @Override
    @KafkaListener(topics = "${kafka.topic}", clientIdPrefix = "secondListener", containerFactory = "factsKafkaListenerContainerFactory")
