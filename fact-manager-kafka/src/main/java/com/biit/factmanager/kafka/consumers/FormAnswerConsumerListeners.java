...
@EnableKafka
@Configuration
public class FormAnswerConsumerListeners extends EventListener<FormRunnerFact> {
    private final FactProvider<FormRunnerFact> factProvider;

    @Autowired
    public FormAnswerConsumerListeners(FactProvider<FormRunnerFact> factProvider) {
        super();
