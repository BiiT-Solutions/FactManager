...
public class FormrunnerQuestionFactRepositoryTests extends AbstractTransactionalTestNGSpringContextTests {
    ...
    private void searchFactByValueQuestionAndAnswerValidDate() {
        Collection<FormrunnerQuestionFact> facts = formrunnerQuestionFactRepository.findBy(null, null, null, null, null, null, null, null, null, null, LocalDateTime.now().minus(1, ChronoUnit.HOURS),
    ...
    private void searchFactByValueQuestionAndAnswerInvalidDate() {
        Collection<FormrunnerQuestionFact> facts = formrunnerQuestionFactRepository.findBy(null, null, null, null, null, null, null, null, null, null, LocalDateTime.now(),
